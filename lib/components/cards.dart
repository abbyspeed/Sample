...
Container supportCard(
    double width, Color colour, Icons icon, double height, String text) {
  return Container(
    ...
    decoration: BoxDecoration(
        color: Color(0xFFFF9446), borderRadius: BorderRadius.circular(20)),
    child: const Row(
      children: [
        Icon(Icons.arrow_outward_rounded, size: 24, color: Colors.black),
        SizedBox(width: 15),
        Text(
          "Read about us",
